...
package set git.url "https://dev.gnupg.org/source/npth.git"
...
package set license "LGPL-2.1-or-later;COPYING.LIB;https://dev.gnupg.org/source/npth/browse/master/COPYING.LIB"
