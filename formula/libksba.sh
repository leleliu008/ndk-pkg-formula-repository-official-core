...
package set git.url "https://dev.gnupg.org/source/libksba.git"
...
package set license "LGPL-3.0-or-later;COPYING.LGPLv3;https://dev.gnupg.org/source/libksba/browse/master/COPYING.LGPLv3"
