...
package set git.url "https://github.com/libimobiledevice/libplist.git"
...
package set license "LGPL-2.1-or-later;COPYING;https://raw.githubusercontent.com/libimobiledevice/libplist/master/COPYING"
