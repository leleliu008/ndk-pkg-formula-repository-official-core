...
package set version "0.9.29"
package set src.url "https://git.openldap.org/openldap/openldap/-/archive/LMDB_${PACKAGE_VERSION}/openldap-LMDB_${PACKAGE_VERSION}.tar.bz2"
