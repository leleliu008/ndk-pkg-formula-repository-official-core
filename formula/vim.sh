...
package set src.url "https://github.com/vim/vim/archive/v8.2.4650.tar.gz"
package set src.sum "f91b3bddaeb538a7a2cc3325cbc80bd1b0009a92407b3a8cb29f7618498fa950"
