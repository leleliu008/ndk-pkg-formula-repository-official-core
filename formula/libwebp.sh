...
package set git.url "https://github.com/webmproject/libwebp.git"
...
package set license "BSD-3-Clause;COPYING;https://raw.githubusercontent.com/webmproject/libwebp/main/COPYING"
