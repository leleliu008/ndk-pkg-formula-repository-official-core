...
package set git.url "https://git.savannah.gnu.org/git/readline.git"
...
package set license "GPL-3.0-or-later;COPYING;https://git.savannah.gnu.org/cgit/readline.git/plain/COPYING"
