...
build() {
    ...
    makew -C $SOURCE_DIR V=1 CC=$CC LD=$CC STRIP=$STRIP OBJCOPY=$OBJCOPY OBJDUMP=$OBJDUMP CPPFLAGS="'$CPPFLAGS'" CFLAGS="'$CFLAGS'" LDFLAGS="'$LDFLAGS'" &&
    makew -C $SOURCE_DIR install PREFIX=$ABI_INSTALL_DIR DESTDIR=
}
