...
package set git.url "https://dev.gnupg.org/source/libassuan.git"
...
package set license "GPL-3.0-or-later;COPYING;https://dev.gnupg.org/source/libassuan/browse/master/COPYING"
