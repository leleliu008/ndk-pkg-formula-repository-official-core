...
prepare() {
    ...
    fetch "http://git.ghostscript.com/?p=ghostpdl.git;a=patch;h=830afae5454dea3bff903869d82022306890a96c" --output-name=ghostscript.patch --sha256=9c282e3f732b5c182ab761e187850d9f4c29d938a93e3785d9cb6ced13111d6c || return 1
    run "patch -p1 < ghostscript.patch"
}
