...
package set git.url "https://code.videolan.org/videolan/dav1d.git"
...
package set license "BSD-2-Clause;COPYING;https://code.videolan.org/videolan/dav1d/-/raw/master/COPYING"
