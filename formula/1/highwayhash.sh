...
build() {
    ...
    makew -C "$SOURCE_DIR" install PREFIX="$TARGET_INSTALL_DIR" CPPFLAGS="'$CPPFLAGS'" CXXFLAGS="'$CXXFLAGS'" LDFLAGS="'$LDFLAGS'" CXX="$CXX" AR="$AR" STRIP_CMD="$STRIP" $MAKE_EXTRA_FLAGS
}
