pkg_set summary "Next-gen compiler infrastructure"
pkg_set webpage "https://llvm.org"
pkg_set git.url "https://github.com/llvm/llvm-project.git"
pkg_set src.url "https://github.com/llvm/llvm-project/releases/download/llvmorg-13.0.0/llvm-project-13.0.0.src.tar.xz"
pkg_set src.sha "6075ad30f1ac0e15f07c1bf062c1e1268c241d674f11bd32cdf0e040c71f2bf3"
pkg_set license "Apache-2.0"
pkg_set dep.pkg "libxml2 libedit libffi"
pkg_set dep.cmd "pkg-config python3:python"
pkg_set bscript "llvm"
